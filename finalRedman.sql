...
INSERT INTO `nodi` VALUES (1,2,3,'Cpu = 1ghz; Ram = 1GB; Hdd = 4gb;','ON',1),(2,2,3,'Cpu = 1ghz; Ram = 1GB; Hdd = 4gb;','ON',2),(3,2,4,'Cpu = 1ghz; Ram = 1GB; Hdd = 4gb;','ON',3),(4,2,4,'Cpu = 2ghz; Ram = 2GB; Hdd = 8gb;','ON',4),(5,8,5,'Cpu = 1ghz; Ram = 2GB; Hdd = 8gb;','OFF',5),(6,8,5,'Cpu = 2ghz; Ram = 1GB; Hdd = 4gb;','OFF',1),(7,9,6,'Cpu = 3ghz; Ram = 3GB; Hdd = 16gb;','OFF',2),(8,9,7,'Cpu = 3ghz; Ram = 3GB; Hdd = 16gb;','OFF',3);
...
INSERT INTO `tasks` VALUES (1,1,NULL,'TASK1','EXE'),(2,1,NULL,'TASK2','EXE'),(3,4,NULL,'TASK3','EXE'),(4,2,NULL,'TASK4','IN PROGRESS'),(5,2,NULL,'TASK5','IN PROGRESS'),(6,3,NULL,'TASK6','FAULT');
...
-- Dump completed on 2018-08-03 12:22:38

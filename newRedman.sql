...
INSERT INTO `nodi` VALUES (1,1,'Cpu = 1ghz; Ram = 1GB; Hdd = 4gb;','ON',1),(2,2,'Cpu = 1ghz; Ram = 1GB; Hdd = 4gb;','ON',2),(3,2,'Cpu = 1ghz; Ram = 1GB; Hdd = 4gb;','ON',3),(4,2,'Cpu = 2ghz; Ram = 2GB; Hdd = 8gb;','ON',4),(5,NULL,'Cpu = 1ghz; Ram = 2GB; Hdd = 8gb;','OFF',5),(6,NULL,'Cpu = 2ghz; Ram = 1GB; Hdd = 4gb;','OFF',1),(7,NULL,'Cpu = 3ghz; Ram = 3GB; Hdd = 16gb;','OFF',2),(8,NULL,'Cpu = 3ghz; Ram = 3GB; Hdd = 16gb;','OFF',3);
...
INSERT INTO `utenti` VALUES (1,'amministratore','admin','admin'),(2,'responsabile di rete','responsabile','responsabile'),(3,'utente semplice','user','user'),(4,'amministratore','anonn','anonn'),(8,'responsabile di rete','anoh','anoj'),(10,'amministratore','sasn','hkasbhk'),(11,'amministratore','adhah','aghach'),(12,'amministratore','adyady','adadyj'),(13,'amministratore','datadtuda','jadayjd');
...
-- Dump completed on 2018-07-26 11:43:44
